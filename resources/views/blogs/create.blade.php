            ...
            <form class="form-horizontal" action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="{{__('Name')}}" id="title" name="title" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Slug" id="slug" name="slug" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="{{__('Publish By')}}" id="publish_by" name="publish_by" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="name">{{__('Publish At')}}</label>
                        <div class="col-sm-10">
                            <input type="date" placeholder="{{__('Meta Title')}}" id="publish_at" name="publish_at" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="excerpt" rows="8" class="form-control"></textarea>
                        </div>
                    </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="name">{{__('HTML Content')}}</label>
                            <div class="col-sm-10">
                                <textarea id="mycontent" name="content" style="height: 500px;"></textarea>
                            </div>
                        </div>
                    </div>
