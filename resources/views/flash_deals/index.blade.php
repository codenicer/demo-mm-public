    ...
    <div class="panel-body">
        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                @foreach($flashDeal  as $key => $flash_deal)

                        <td>{{$key+1}}</td>
                        <td>{{$flash_deal->title}}</td>
                        <td>{{ date('M d-Y h:i:s a', strtotime($flash_deal->start_date)) }}</td>
                        <td>{{ date('M d-Y h:i:s a', strtotime($flash_deal->end_date)) }}</td>
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="{{route('flash_deals.product_prio', encrypt($flash_deal->id))}}">{{__('Manage Prioritization')}}</a></li>
