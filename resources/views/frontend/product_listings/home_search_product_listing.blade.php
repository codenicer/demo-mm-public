        ...
        <div class="row">
                    ...
                    <div class="box-content">
                        <div class="category-accordion">
                            ...
                            <div class="single-category">
                                ...
                                @else
                                <a class='w-100 sub-category-name' href="{{ route('product.category', $cat['slug']) }}"
                                    style="color:{{$key == $categoryName ? '#eb7c16' : ''}}">
                                    {{ __($key) }}
                                    ({{$cat['count']}})</a>
                                @endif
            ...
            <div class="col-xl-9">
                <form class="" name="form2"
                    ...
                    @else action="{{ route('products.campaign-sortby', ['slug' => $campaign->slug]) }}" @endif --}}
                    method="GET">
                    @csrf
                </form>
                <form class="" id="search-form1" method="GET">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
            cartQuantityInitialize('.search_result-btn-number', '.search_result-input-number');
            cardQuantityResponsivenessHandler('.search_result');
            lazyLoad('search_result');
