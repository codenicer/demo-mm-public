                                    ...
                                    <table class="table table-sm table-hover table-responsive-md">
                                        ...
                                        <tbody>
                                            @foreach ($orders as $key => $order)
                                                <tr>
                                                    <td>
                                                        <a href="#{{ $order->order_name }}" onclick="show_purchase_history_details({{ $order->order_id }})">{{ $order->order_name }}</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{ single_price($order->total_price) }}
                                                    </td>
                                                    <td>
                                                        {{$order['delivery_date']}}
                                                        <br>
                                                    ...
                                                    @endphp
                                                        @if($order->delivery_viewed == 0)
                                                            <span class="" style="color:green"><strong>({{ __('Updated') }})</strong></span>
                                                        @else
                                                    ...
                                                    <td>
                                                    {{getPaymentMethodNameByID($order['payment_id'])}}
                                                    <br>
                                                        <span class="badge badge--2 mr-4 text-left">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="">
                                                                <button onclick="show_purchase_history_details({{ $order->order_id }})" class="dropdown-item">{{__('Order Details')}}</button>
                                                                <!-- <a href="{{ route('customer.invoice.download', $order->order_id) }}" class="dropdown-item">{{__('Download Invoice')}}</a> -->
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
