                        ...
                        <div class="card">
                            ...
                            @if($errors->all())
                                @foreach ($errors->all() as $error)
                                    <div class="text-left px-5 py-3 color ">{{ $error }}</div>
                                @endforeach
                            @endif
                            </div>
                            <div class="px-5 py-3 py-lg-4">
                                <div class="">
                                    <form id="form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <div class="input-group input-group--style-1">
                                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="{{ __('First Name') }}" name="first_name">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group--style-1">
                                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="{{ __('Last Name') }}" name="last_name">
                                                <span class="input-group-addon">
                                                    <i class="text-md la la-user"></i>
                                                </span>
                                        ...
                                        <div class="form-group d-none" >
                                            ...
                                            <div class="input-group input-group--style-1">
                                                <input id="confirm_password" type="password" class="form-control" placeholder="{{ __('Confirm Password') }}" name="password_confirmation">
                                                <span class="input-group-addon">
                                                    <i class="text-md la la-lock"></i>
                                                </span>
                                            </div>
                                    ...
                                    @if(\App\BusinessSetting::where('type', 'google_login')->first()->value == 1 || \App\BusinessSetting::where('type', 'facebook_login')->first()->value == 1 || \App\BusinessSetting::where('type', 'twitter_login')->first()->value == 1)
                                        ...
                                        @if (\App\BusinessSetting::where('type', 'twitter_login')->first()->value == 1)
                                            <a href="#" class="btn btn-styled btn-block btn-twitter btn-icon--2 btn-icon-left px-4">
