                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['product_bulk_update.index'])}}">
                                         <a class="nav-link" href="{{route('product_bulk_update.index')}}">{{__('Bulk Update')}}</a>
                                    </li>
                                    ...
                                    <li class="{{areActiveRoutes(['product_price_bulk_update.index'])}}">
                                         <a class="nav-link" href="{{route('product_price_bulk_update.index')}}">{{__('Bulk Stock/Price Update')}}</a>
                                    </li>
                        ...
                        {{--@if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))--}}
                            {{--@php--}}
                                {{--$orders = DB::table('orders')--}}
                                            ...
                                            {{--->where('order_item.seller_id', \App\User::where('user_type', 'admin')->first()->id)--}}
                                            {{--->select('orders.id')--}}
                                            {{--->distinct()--}}
                                            {{--->count();--}}
                            {{--@endphp--}}
                            ...
                            <a class="nav-link" >
                                ...
                                <ul class="collapse">
                                    <li class="{{areActiveRoutes(['pages.index'])}}">
                                        <a class="nav-link" href="{{ route('pages.index') }}" >{{__('List')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['pages.create'])}}">
                                        <a class="nav-link" href="{{route('pages.create')}}">{{__('Create Page')}}</a>
                                    </li>
                                </ul>
                        </li>
                        @endif
                            ...
                            <a class="nav-link" >
                                ...
                                <ul class="collapse">
                                    <li class="{{areActiveRoutes(['blog.index'])}}">
                                        <a class="nav-link" href="{{ route('blog.index')}}" >{{__('List')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['blog.create'])}}">
                                        <a class="nav-link"  href="{{ route('blog.create')}}"  >{{__('Create Blog')}}</a>
                                    </li>
                                </ul>
                        </li>
                        @endif
...
<!-- start collection_r-->
                        ...
                        <li class="{{ areActiveRoutes(['collections.index', 'collections.create', 'collections.edit_collection'])}}" >
                            <a class="nav-link" >
                                <i class="fa fa-newspaper-o" ></i>
                            <span class="menu-title">{{__('Manage Collections')}}</span>
                                <i class="arrow"></i>
                            </a>
                                <ul class="collapse">
                                    <li class="{{areActiveRoutes(['collections.index'])}}">
                                        <a class="nav-link" href="{{ route('collections.index')}}" >{{__('List')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['collections.create'])}}">
                                        <a class="nav-link"  href="{{ route('collections.create')}}"  >{{__('Create Collection')}}</a>
                                    </li>
                                </ul>
                        </li>
                        @endif
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('4', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="{{ areActiveRoutes(['calendar.index', 'calendar.create', 'calendar.edit'])}}" >
                            <a class="nav-link" >
                                <i class="fa fa-calendar-plus-o" ></i>
                            <span class="menu-title">{{__('Manage Calendar')}}</span>
                                <i class="arrow"></i>
                            </a>
                                <ul class="collapse">
                                    <li class="{{areActiveRoutes(['calendar.index'])}}">
                                        <a class="nav-link" href="{{ route('calendar.index')}}" >{{__('List')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['calendar.create'])}}">
                                        <a class="nav-link"  href="{{ route('calendar.create')}}"  >{{__('Create Rule')}}</a>
                                    </li>
                                </ul>
                        </li>
                        @endif
...
<!-- end collection_r-->
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="{{ areActiveRoutes(['campaigns.index', 'campaigns.products', 'campaigns.update', 'campaigns.update_enable', 'campaigns.update_active'])}}">
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['web_hubs.index','web_hubs.create','web_hubs.edit'])}}">
                                    <a class="nav-link" href="{{route('web_hubs.index')}}">{{__('Manage Web Hub')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['hubs.index','hubs.create','hubs.edit'])}}">
                                    <a class="nav-link" href="{{route('hubs.index')}}">{{__('Manage Hub')}}</a>
                                </li>
                        ...
                        {{--@if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))--}}
                            {{--@php--}}
                                {{--$support_ticket = DB::table('web_tickets')--}}
                                            {{--->where('viewed', 0)--}}
                                            {{--->select('id')--}}
                                            {{--->count();--}}
                            {{--@endphp--}}
