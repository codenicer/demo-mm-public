				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" id="name" name="name" placeholder="{{__('Product Name')}}" value="{{old('name')}}" onblur="generate_sku()" required>
									@if($errors->has('name'))
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="sku" id="sku" placeholder="{{__('Product SKU')}}"  value="{{old('sku')}}" onchange="update_sku()" required>
									@if($errors->has('sku'))
										<span class="invalid-feedback text-left" role="alert">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="unit" placeholder="Unit (e.g. KG, Pc etc)"  value="{{old('unit')}}" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Tags')}}</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="tags[]" placeholder="Type to add a tag" data-role="tagsinput" value="{{old('tags')}}">
								</div>
							</div>
						...
						<div id="demo-stk-lft-tab-4" class="tab-pane fade">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="meta_title" placeholder="{{__('Meta Title')}}" value="{{old('meta_title')}}">
								</div>
							</div>
							<div class="form-group">
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('unit_price',0)}}" step="0.01" placeholder="{{__('Unit price')}}" name="unit_price" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Purchase price')}}</label>
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('purchase_price',0)}}" step="0.01" placeholder="{{__('Purchase price')}}" name="purchase_price" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Campaign price')}}</label>
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('campaign_price',0)}}" step="0.01" placeholder="{{__('Campaign price')}}" name="campaign_price" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Tax')}}</label>
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('tax',0)}}" step="0.01" placeholder="{{__('Tax')}}" name="tax" class="form-control" required>
								</div>
								<div class="col-lg-1">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('discount',0)}}" step="0.01" placeholder="{{__('Discount')}}" name="discount" class="form-control" required>
								</div>
								<div class="col-lg-1">
							...
							<div class="form-group" id="quantity">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('quantity',0)}}" step="1" placeholder="{{__('Quantity')}}" name="current_stock" class="form-control" required>
								</div>
							</div>
							<br>
							...
							<div class="row">
								...
								<div class="col-md-10">
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="number" min="0" value="{{old('flat_shipping_cost',0)}}"  step="0.01" placeholder="{{__('Shipping cost')}}" name="flat_shipping_cost" class="form-control" required>
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
    ...
    function generate_sku(){
	    var name = $('#name').val();
	    if(name){
            $.post('{{ route('products.generateSKUFromName') }}',{_token:'{{ csrf_token() }}', name: name}, function(data){
                try{
                    if(data){
                        $('#sku').val(data);
                    }
                }catch(error){
                    console.log('error in generating sku')
                }
            });
		}
