				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="sku" id="sku" placeholder="{{__('Product SKU')}}"  value="{{$product->sku}}" readonly required>
									@if($errors->has('sku'))
										<span class="invalid-feedback text-left" role="alert">
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" placeholder="{{__('Unit price')}}" name="unit_price" class="form-control" value="{{old('unit_price',$product->unit_price)}}" required>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Purchase price')}}</label>
	                            <div class="col-lg-7">
	                                <input type="number" min="0" step="0.01" placeholder="{{__('Purchase price')}}" name="purchase_price" class="form-control" value="{{old('purchase_price',$product->purchase_price)}}" required>
	                            </div>
	                        </div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Campaign price')}}</label>
								<div class="col-lg-7">
									<input type="number" min="0" value="{{old('campaign_price',$product->purchase_price)}}" step="0.01" placeholder="{{__('Campaign price')}}" name="campaign_price" class="form-control" required>
								</div>
							</div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Tax')}}</label>
	                            <div class="col-lg-7">
	                                <input type="number" min="0" step="0.01" placeholder="{{__('tax')}}" name="tax" class="form-control" value="{{old('tax',$product->tax)}}" required>
	                            </div>
	                            <div class="col-lg-1">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="number" min="0" step="0.01" placeholder="{{__('Discount')}}" name="discount" class="form-control" value="{{old('discount',$product->discount) }}" required>
	                            </div>
	                            <div class="col-lg-1">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#photos").spartanMultiImagePicker({
			...
			maxCount:         10,
			rowHeight:        '200px',
			groupClassName:   'col-md-4 col-sm-4 col-xs-6 bago',
			maxFileSize:      '',
